...
// keyString MUST BE 56 BITS/7 BYTES (14 CHARS)
const string keyString = "55586753090210";

const int dataPattern[64] = { 57, 49, 41, 33, 25, 17,  9, 1,
...
const int keyPattern[56] = { 49, 42, 35, 28, 21, 14,  7,
							   0, 50, 43, 36, 29, 22, 15,
							   8,  1, 51, 44, 37, 30, 23,
							  16,  9,  2, 52, 45, 38, 31,
							  ...
							  12,  5, 53, 46, 39, 32, 25,
							  18, 11,  4, 24, 17, 10,  3 };
const int keyLeft[28] = { 13, 16, 10, 23,  0,  4,
							2, 27, 14,  5, 20,  9,
							22, 18, 11,  3, 25,  7,
							15,  6, 26, 19, 12,  1 };
const int keyRight[28] = { 12, 23,  2,  8, 18, 26,
							1, 11, 22, 16,  4, 19,
							15, 20, 10, 27,  5, 24,
							17, 13, 21,  7,  0,  3 };
...
const int sBoxPerm[32] = { 15,  6, 19, 20,
							28, 11, 27, 16,
							0, 14, 22, 25,
							4, 17, 30,  9,
							1,  7, 23, 13,
							...
							18, 12, 29,  5,
							21, 10,  3, 24 };
const int finalPerm[64] = { 39,  7, 47, 15, 55, 23, 63, 31,
